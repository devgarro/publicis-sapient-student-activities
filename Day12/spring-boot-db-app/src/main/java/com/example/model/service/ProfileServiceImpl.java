...
public class ProfileServiceImpl implements ProfileService {
	...
	//spring supplies object of ProfileRepository
	@Autowired
	...
	@Transactional //needed because modifying db
	@Override
	...
	public Profile fetchProfile(int id) throws ProfileNotFoundException {
		...
		if(profile == null) {
			throw new ProfileNotFoundException("Profile with id: "+id+" is not found!");
		}
